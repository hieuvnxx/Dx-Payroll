...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create(DxServiceProvider::DX_PREFIX_TABLE.'general_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists(DxServiceProvider::DX_PREFIX_TABLE.'general_settings');
    }
};
