 ...
 */
class MonthlyWorkingTimeController extends BaseController
{
    protected $zohoLib;
    protected $zohoForm;
    ...
    public function processByCode(ApiWorkingTimeByCode $request)
    {
        ...
        $employeeIdNumberFieldLabel = Env::get('EMPLOYEE_FORM_ID_NUMBER_FIELD_LABEL', null);
        $constantConfigFormLinkName = Env::get('PAYROLL_CONSTANT_CONFIGURATION_FORM_LINK_NAME', null);
        $monthlyWorkingTimeFormLinkName = Env::get('PAYROLL_MONTHY_WORKING_TIME_FORM_LINK_NAME', null);
        ...
        */
        ...
        if (empty($tabularData)) {
            return $this->sendError($request, 'Something error. Can not generate attendance detail.');
        }
