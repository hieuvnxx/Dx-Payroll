...
class MigrateZohoDataSalaryModule extends Command
{
    protected $signature = 'dxpayroll:migrateZohoDataSalaryModule';
     ...
     * @var string
     */
    protected $description = 'Command to migrate data salary module';
