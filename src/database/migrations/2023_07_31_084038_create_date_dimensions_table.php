...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create(DxServiceProvider::DX_PREFIX_TABLE.'date_dimensions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(DxServiceProvider::DX_PREFIX_TABLE.'date_dimensions');
    }
};
